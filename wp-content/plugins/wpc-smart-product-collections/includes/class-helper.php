									...
									if ( ! empty( $conditions ) ) {
										...
										foreach ( $conditions as $condition ) {
											...
											if ( ! empty( $condition['apply'] ) && ! empty( $condition['compare'] ) && ! empty( $condition['value'] ) ) {
												if ( ( $condition['compare'] === 'is' ) && has_term( $condition['value'], $condition['apply'], $product_id ) ) {
													$__match = true;
												}

												if ( ( $condition['compare'] === 'is_not' ) && ! has_term( $condition['value'], $condition['apply'], $product_id ) ) {
													$__match = true;
												}
											}
