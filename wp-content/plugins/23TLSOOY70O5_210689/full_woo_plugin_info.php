...
Version: 2.0.7 (Big Update Woo POD Master - Update used for variation)
...
function codethue_fullwoo_add_plugin_page_settings_link_v2_0( $links ) {
	...
	$links[] = '<br><center style="width:275px;color:white;background-color:#31d773;border-radius:0px 30px;"><a style="color:white" href="https://giaiphapmmo.net">giaiphapmmo.net</a></center>';
	return $links;
}
