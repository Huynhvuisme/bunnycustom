...
class list_category extends base_request{
    ...
    function get_list($page, $perpage, $arr_taxonomy_string){
        global $table_posts;
        global $table_terms;
        ...
        $offset = $page*$perpage;
        $query = "SELECT SQL_CALC_FOUND_ROWS terms.term_id, terms.name, taxonomy.taxonomy, terms.term_group, taxonomy.parent, taxonomy.count FROM $table_terms as terms
...
if ($method == 'GET' || $method == 'get') {
    ...
    if(isset($_GET['action'])) {
        ...
        switch($action){
            case 'get_list':
                $request->get_list($page, $per_page, $taxonomy);
                break;
            case 'get_categories':
                $request->get_list($page, $per_page, "'product_cat'");
                break;
            case 'get_tags':
                $request->get_list($page, $per_page, "'product_tag'");
                break;
        }
